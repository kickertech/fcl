      ...
      <md-card>
        <md-card-content>
          <div class="about">
            <h1>About</h1>
            <p>
              Hey! Das hier ist ein open-source tool. Wenn ihr bugs findet,
              Ideen habt oder mitarbeiten wollt macht gerne auf
              <a href="https://github.com/kickertech/fcl">GitHub</a> ein issue
              auf oder schreibt eine E-Mail an
              <a href="mailto:beller.moritz[aeht]googlemail.com"
                >beller.moritz[aeht]googlemail.com</a
              >
              oder
            </p>
            <h2>Impressum</h2>
            ...
            <ul>
              <li>
                Wir nutzen <b>kein Tracking</b> und nutzen Cookies nur wenn es
                unbedingt Notwendig ist (Datensparsamkeit!).
              </li>
              <li>
                Du kannst die Webseite ohne Cookies und ohne Login nutzen. Die
                Daten werden dann <b>nur lokal in deinem Browser</b> gespeichert
              </li>
              <li>
                Wenn du dir einen Account machst werden deine Spiele in der
                Cloud gespeichert (in Frankfurt) und du kannst auf diese Daten
                von jedem Browser aus zugreifen.
              </li>
            </ul>
            ...
            <p>
              Moritz Johner<br />Wohlwillstraße 52<br />20359 Hamburg<br />Deutschland
            </p>
            <p>
              Telefon: 0176 98847129<br />E-Mail: beller.moritz@googlemail.com
            </p>
            ...
            <p>
              ...
              verwiesen. Die dabei von uns erhobenen Daten werden ausschließlich
              für die Zurverfügungstellung des Kundenkontos verwendet.&nbsp;
            </p>
            <p>
